...
> **Disambiguation**: the "Layer 1/2/3" below is this doc's own step order (Static Checks →
> Stack & Service Validation → Runtime Verification) — System C in
> `framework/_shared/layers-and-gates.md`. It is distinct from the "Layer 1/2/3: Task Execution"
> system used elsewhere (`skills/sdd-validator/SKILL.md`), even though both appear under
> `/sdd.build`.
