...
if saved_description exists in meta.md:
    ...
    option_1_description = "Uses your description to seed the spec — comando em sonnet"
else:
    option_1_label = "/sdd.spec (Recommended)"
    option_1_description = "Start spec creation interactively — comando em sonnet"
```
...
AskUserQuestion(
  questions=[{
    ...
    "header": "Next",
    "options": [
      {"label": "/sdd.spec (Recommended)", "description": "Start spec creation interactively — comando em sonnet"},
...
> **Note**: If saved description exists in meta.md, first option label should be "/sdd.spec (with saved context)" with description "Uses your description to seed the spec — comando em sonnet".
**On user selection**:
