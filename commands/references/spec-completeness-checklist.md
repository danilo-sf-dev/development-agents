...
> Validate based on feature type detected inline — scan the description/answers directly for data-processing, calculation, async/event, external-integration, and storage signals
