...
| platformCli        | apps/misc/go/platformCli         | git@github.com:org/platformCli     | Go     | Internal CLI tool      |
...
Create or update `.gitignore` at the hub root to ignore all member app directories. This prevents accidentally committing platform app code into the hub repo.
...
# Hub member apps — managed independently, not tracked by this repo
platform-apps/
platform-apps/backend/go/campaign-api/
platform-apps/frontend/react/campaign-web/
apps/misc/go/platformCli/
```
