...
| Condition | Reference |
|-----------|-----------|
| `INFRA-TASK-*` in tasks.json | `references/build-infra-creation.md` |
| `migration.detected` + branch pending | `references/database-migration.md` |
| `platform.type` = android \| ios | `references/build-mobile-preamble.md` |
