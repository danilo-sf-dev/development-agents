...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| **Working directory** | cwd is the **target project root** (the pack lives at `development-agents/` inside the target project, never in the user's home directory), not inside the pack-only hub itself | STOP — change directory                   |
